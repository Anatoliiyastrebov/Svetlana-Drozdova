...
export const translations = {
  ru: {
    ...
    welcomeDescription: 'Выберите подходящий вариант и заполните его. После изучения ответов я с вами свяжусь.\nСветлана, ваш wellness-консультант.',
    ...
    // DSGVO
    dsgvoConsent: 'Даю согласие на обработку персональных данных в соответствии с Политикой обработки персональных данных (ФЗ-152).',
  ...
  en: {
    ...
    // DSGVO
    dsgvoConsent: 'I consent to personal data processing according to the Privacy Policy.',
